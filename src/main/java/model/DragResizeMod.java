...
public class DragResizeMod {
    ...
    private DragResizeMod(Node node, OnDragResizeEventListener listener, Callback callback) {
        this.node = node;
        if (listener != null)
    ...
    public static void makeResizable(Node node) {
        makeResizable(node, null, null);
    }

    public static void makeResizable(Node node, Callback callback) {
        makeResizable(node, null, callback);
    }

    public static void makeResizable(Node node, OnDragResizeEventListener listener, Callback callback) {
        final DragResizeMod resizer = new DragResizeMod(node, listener, callback);
